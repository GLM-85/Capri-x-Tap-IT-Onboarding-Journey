      ...
      <main className="flex-grow">
        ...
        <section className="relative pt-12 md:pt-20 pb-14 px-6 overflow-hidden">
           ...
           <div className="container mx-auto max-w-6xl relative z-10 text-center md:text-left">
              <div className="inline-block px-4 py-2 bg-[#436E72] text-white text-xs font-bold uppercase tracking-widest rounded-full mb-8">
                  Journey Overview
              </div>
              <h1 className="text-5xl md:text-7xl font-black font-sans uppercase leading-[0.9] tracking-tight mb-8 text-[#294344]">
                 Capri × Tap-IT <br />
                 <span className="text-[#EE7E5A]">Onboarding Journey</span>
              </h1>
              ...
              <div className="grid grid-cols-1 gap-8">
                 {phases.map((phase) => (
                    <Link 
                        ...
                        className="group bg-white p-6 md:p-8 rounded-[2rem] shadow-sm border border-transparent hover:border-[#EE7E5A] hover:shadow-xl transition-all duration-300 relative overflow-hidden"
                    >
                        <div className="flex flex-col md:flex-row gap-8 items-start md:items-center relative z-10">
                            {/* Number Badge */}
                            <div className="w-16 h-16 md:w-20 md:h-20 bg-[#EDE8E4] rounded-full flex items-center justify-center shrink-0 group-hover:bg-[#EE7E5A] transition-colors duration-300">
                                <span className="text-2xl md:text-3xl font-black text-[#436E72] group-hover:text-white transition-colors">
                                    {phase.number}
                                </span>
                            </div>
                            ...
                            <div className="flex-grow">
                                <h3 className="text-3xl md:text-4xl font-black font-sans uppercase text-[#294344] mb-2 group-hover:text-[#EE7E5A] transition-colors">
                                    {phase.title}
                                </h3>
                                ...
                                <div className="flex flex-wrap gap-3">
                                    <span className="px-3 py-1 bg-[#436E72]/5 text-[#436E72]/70 text-[10px] font-bold uppercase tracking-wider rounded">
                            ...
                            {/* CTA Arrow */}
                            <div className="w-12 h-12 rounded-full border border-[#BDB9B6] flex items-center justify-center text-[#202020] group-hover:bg-[#EE7E5A] group-hover:border-[#EE7E5A] group-hover:text-white transition-all shrink-0">
        ...
        {/* --- HOW IT WORKS --- */}
        <section className="py-20 px-6 bg-[#294344] text-white mt-12">
            <div className="container mx-auto max-w-6xl">
                <div className="flex flex-col md:flex-row gap-16">
                    <div className="md:w-1/3 max-w-md">
                        <div className="inline-block px-3 py-1 bg-[#436E72] text-white text-[10px] font-bold uppercase tracking-widest rounded-full mb-4">
                            Werkwijze
                        </div>
                    ...
                    <div className="md:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-10">
                        {[
                            ...
                            <div key={i} className="bg-[#436E72]/80 p-6 rounded-2xl">
                                <div className="w-8 h-8 bg-[#EE7E5A] rounded-full mb-4 flex items-center justify-center">
